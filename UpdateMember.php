...
<body>
	...
	if(isset($_POST['password'])&&isset($_POST['email']))
	{
		...
		else
		{
			...
			$pw=$_POST['password'];
			$em=$_POST['email'];
			$sql="UPDATE member SET Password=TO_BASE64('$pw'),Email='$em' WHERE Account='$ac'";
			$result=mysqli_query($link,$sql);
			if($result){echo "<Script language='javascript'>alert('更新成功');</Script>";}
	...
	<form action="UpdateMember.php" method="post">
        ...
        echo "<label for='account'>▲</label><input class='login'  type='text' value='$ac'  disabled='disabled' name='account' ><br>";?>
